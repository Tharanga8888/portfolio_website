...
<body>
	...
	<?php
		include "header.html"; 
		include "content_about_intro.html" ;
		include "content_about_personal_info.html" ;
		include "content_about_characteristics.html" ;
		include "content_education.html" ;
		include "content_extra_ca.html" ;
		include "content_gallery.html" ;
		include "content_contact.html" ;
		include "footer.html" ;
	?>
